...
const Station InternetRadio::stations_test_[NUM_STATIONS] = {
    ...
    {"HLS 48k BBC R3",   "http://a.files.bbci.co.uk/media/live/manifesto/audio/simulcast/hls/nonuk/sbr_low/ak/bbc_radio_three.m3u8"},
    {"HLS 48k BBC R4",   "http://a.files.bbci.co.uk/media/live/manifesto/audio/simulcast/hls/nonuk/sbr_low/ak/bbc_radio_fourfm.m3u8"},
